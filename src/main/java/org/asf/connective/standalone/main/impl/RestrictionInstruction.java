...
public class RestrictionInstruction implements ContextFileInstruction {
	...
	public class DefaultRestrictionProvider implements IFileRestrictionProvider {

		private String[] arguments;

		public DefaultRestrictionProvider(String[] args) {
			arguments = args;
		}
		...
		public IFileRestrictionProvider newInstance() {
			return new DefaultRestrictionProvider(arguments);
		}
	...
	public void run(String[] arguments, ProviderContextFactory factory) throws Exception {
		if (arguments[0].startsWith("class:")) {
			...
			factory.addRestriction(new DefaultRestrictionProvider(arguments));
		} else {
