...
public abstract class ExampleModificationManager extends CyanComponent {
	...
	private static ExampleModificationManager instance;
	private static boolean prepared = false;

	/**
	 * Assigns the instance.
	 */
	protected static void assign(ExampleModificationManager instance) {
		ExampleModificationManager.instance = instance;
	}
